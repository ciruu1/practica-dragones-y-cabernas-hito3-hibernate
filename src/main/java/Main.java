...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            Personaje personaje = controlador.createPersonaje("Stanto", 10, 80, "Alto", 1000, jugador, 200);
            Daga daga = controlador.createDaga("Daga de madera", personaje);
            Mago mago = controlador.createMago(5, 600, 100, personaje);
            if (daga != null && mago != null && jugador != null && personaje != null)
                System.out.println("Se ha creado el mago " + mago.getNombre_p().getNombre_p() + " de nivel 1 con la daga " + daga.getNombre_d());
